...
Tests the /calculations endpoints with database integration.
"""
import pytest
...
class TestCalculationCreate:
    """Test calculation creation (Add) endpoint"""

    def test_add_calculation_success(self, setup_database, clean_db):
    ...
    def test_add_calculation_subtract(self, setup_database, clean_db):
    ...
    def test_add_calculation_multiply(self, setup_database, clean_db):
